...
# Detailed tutorial
We refer the user to [DRDNetPro](https://github.com/chencxxy28/DRDNetPro) for more detailed implementation, which is the bio-propocol for implementing DRDNet.
