...
#output
data_output<-data.frame(mse,mse_1,mse_0,mse_diff,count_edge,count_edge_interaction,count_edge_total,count_edge_total_interaction)
write.csv(data_output,"/storage/home/cuc472/network/simulation_07262021/estimated_agent/high_dimension/n100v1/data_output10.csv",row.names = F)
